...
/**
 ...
 Description: This plugin generates a login form for MyCompanyFiles service. Use [mcf-login] shortcode or Gutenberg Block.
...
// Include Gutenberg definition
require_once(plugin_dir_path(__FILE__) . '/blocks/mcf-login-form/mcf-login-gutenberg.php');
...
add_shortcode('mcf_login', 'mcf_login_shortcode');
...
{
    // Javascript file
    wp_enqueue_script('mcf-login-js-file', plugins_url('/my-company-files-login/assets/js/mcf-login.js'), array('jquery'), '1.0.0', true);
    // Stylesheet
    wp_register_style('mcf-login-stylesheet', plugins_url('/my-company-files-login/assets/css/mcf-login.css'), array(), '1.0.0', 'all');
